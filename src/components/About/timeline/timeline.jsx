...
export default function Timeline() {
  const timelines = [ 
    {
      title: '2019/1',
      desc: `Minha fascinação pela programação começou na Análise e Desenvolvimento de Sistemas. Agora, busco constantemente aprimorar minhas habilidades nessa área maravilhosa.`
    },
    {
      title: '2019/2',
    ...
    {
      title: '2023',
      desc: 'Iniciei três novos projetos e mergulhei ainda mais no mundo da programação, aprimorando meus conhecimentos em LUA, PHP, MySQL e outras tecnologias, além de iniciar a construção do meu portfólio.'
    },
  ]
  return (
